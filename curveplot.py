...
plt.plot(list(mlp_curve.keys()), gaussian_filter1d(list(mlp_curve.values()), sigma=5), label = 'MLP score')
plt.xlabel('Época')
plt.ylabel('RMSE')
plt.legend()

plt.figure(figsize=(20, 20))
plt.plot(list(anfis_curve.keys()), gaussian_filter1d(list(anfis_curve.values()), sigma=5), label = 'ANFIS score')
plt.xlabel('Época')
plt.ylabel('RMSE')
plt.legend()
